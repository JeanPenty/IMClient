...
namespace SOUI
{
    ...
    public:
        ...
        MenuItemWrapper* AddMenu(const SStringW& text, int id, BOOL bEnable = TRUE, BOOL bCheck = FALSE, SStringW sstrFont = L"size:12");
        void AddSeperator();
		...
		void AddChildMenu(const SStringW& text, int id, BOOL bEnable = TRUE, BOOL bCheck = FALSE);
    ...
    private:
		...
		std::map<MenuItemWrapper, VecMenuItems>		map_menuChildItems;
    };
